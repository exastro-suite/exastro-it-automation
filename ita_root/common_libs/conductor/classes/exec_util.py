...
class ConductorExecuteLibs():
    ...
    def notice_request_call(self, method, url, content=None, header=None, proxySetting=None):
        ...
        try:
            ...
            response_dict["err_type"] = err_type
            g.applogger.info(addline_msg('{}{}'.format(response_dict, sys._getframe().f_code.co_name)))
...
class ConductorExecuteBkyLibs(ConductorExecuteLibs):
    ...
    def set_storage_path(self):
        ...
        try:
            ...
            t = traceback.format_exc()
            g.applogger.info("[timestamp={}] {}".format(str(get_iso_datetime()), arrange_stacktrace_format(t)))
            g.applogger.info("tmp_result={}".format(tmp_result))
    ...
    def add_execution_log(self, parameter, str_msg=''):
        ...
        retBool = True
        try:
            g.applogger.info(addline_msg('{}'.format(sys._getframe().f_code.co_name)))
