...
ALTER TABLE T_OASE_ACTION_LOG ADD COLUMN PARAMETER_SHEET_ID VARCHAR(40) AFTER HOST_ID;
ALTER TABLE T_OASE_ACTION_LOG_JNL ADD COLUMN PARAMETER_SHEET_ID VARCHAR(40) AFTER HOST_ID;
