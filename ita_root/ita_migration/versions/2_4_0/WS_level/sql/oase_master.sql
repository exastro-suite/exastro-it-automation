...
UPDATE T_COMN_MENU_COLUMN_LINK SET REF_TABLE_NAME = 'V_OASE_LABEL_KEY_GROUP', INITIAL_VALUE = '[["_exastro_type", "≠", "conclusion"]]', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010704';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET REF_TABLE_NAME = 'V_OASE_LABEL_KEY_GROUP', INITIAL_VALUE = '[["_exastro_type", "≠", "conclusion"]]', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010704';
...
UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '60', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010705';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '60', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010705';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '70', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010706';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '70', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010706';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '80', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010707';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '80', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010707';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '90', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010708';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '90', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010708';

UPDATE T_COMN_MENU_COLUMN_LINK SET REQUIRED_ITEM = '0', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010803';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET REQUIRED_ITEM = '0', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010803';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '90', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010805';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '90', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010805';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '100', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010806';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '100', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010806';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '110', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010807';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '110', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010807';

UPDATE T_COMN_MENU_COLUMN_LINK SET COLUMN_DISP_SEQ = '120', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010808';
UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET COLUMN_DISP_SEQ = '120', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010808';

UPDATE T_COMN_MENU_COLUMN_LINK SET REF_TABLE_NAME = 'V_OASE_CONCLUSION_LABEL_KEY_GROUP', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010916';

UPDATE T_COMN_MENU_COLUMN_LINK_JNL SET REF_TABLE_NAME = 'V_OASE_CONCLUSION_LABEL_KEY_GROUP', LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE COLUMN_DEFINITION_ID = '11010916';
...
-- T_OASE_CONNECTION_METHOD: UPDATE
UPDATE T_OASE_CONNECTION_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE CONNECTION_METHOD_ID = '1';
UPDATE T_OASE_CONNECTION_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE CONNECTION_METHOD_ID = '2';
UPDATE T_OASE_CONNECTION_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE CONNECTION_METHOD_ID = '4';
UPDATE T_OASE_CONNECTION_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE CONNECTION_METHOD_ID = '5';

-- T_OASE_REQUEST_METHOD: UPDATE
UPDATE T_OASE_REQUEST_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE REQUEST_METHOD_ID = '1';
UPDATE T_OASE_REQUEST_METHOD SET DISUSE_FLAG = '0' , LAST_UPDATE_TIMESTAMP = _____DATE_____ WHERE REQUEST_METHOD_ID = '2';
