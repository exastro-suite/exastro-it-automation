...
-- 20412 Role 作業管理
ALTER TABLE T_ANSR_EXEC_STS_INST     ADD COLUMN IF NOT EXISTS EXECUTE_HOST_NAME VARCHAR(40)  AFTER MULTIPLELOG_MODE;
ALTER TABLE T_ANSR_EXEC_STS_INST_JNL ADD COLUMN IF NOT EXISTS EXECUTE_HOST_NAME VARCHAR(40)  AFTER MULTIPLELOG_MODE;
-- ------------------------------------------------------------
-- ▲ TABLE UPDATE END
-- ------------------------------------------------------------
...
-- ▼ INDEX CREATE END
-- ------------------------------------------------------------
CREATE INDEX IF NOT EXISTS IND_T_ANSL_MATL_COLL_01          ON T_ANSL_MATL_COLL(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_MVMT_VAR_LINK_01      ON T_ANSL_MVMT_VAR_LINK(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_MVMT_VAR_LINK_02      ON T_ANSL_MVMT_VAR_LINK(MVMT_VAR_LINK_ID, MOVEMENT_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_MVMT_MATL_LINK_01     ON T_ANSL_MVMT_MATL_LINK(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_MVMT_MATL_LINK_02     ON T_ANSL_MVMT_MATL_LINK(MOVEMENT_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_VALUE_AUTOREG_01      ON T_ANSL_VALUE_AUTOREG(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_VALUE_AUTOREG_02      ON T_ANSL_VALUE_AUTOREG(COLUMN_ID, MOVEMENT_ID, DISUSE_FLAG, MVMT_VAR_LINK_ID, ASSIGN_SEQ);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_VALUE_AUTOREG_03      ON T_ANSL_VALUE_AUTOREG(COLUMN_LIST_ID);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_TGT_HOST_01           ON T_ANSL_TGT_HOST(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_TGT_HOST_02           ON T_ANSL_TGT_HOST(EXECUTION_NO, OPERATION_ID, MOVEMENT_ID, SYSTEM_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_VALUE_01              ON T_ANSL_VALUE(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_VALUE_02              ON T_ANSL_VALUE(EXECUTION_NO, OPERATION_ID, MOVEMENT_ID, SYSTEM_ID, MVMT_VAR_LINK_ID, ASSIGN_SEQ, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSL_EXEC_STS_INST_01      ON T_ANSL_EXEC_STS_INST(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_DIALOG_TYPE_01        ON T_ANSP_DIALOG_TYPE(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_OS_TYPE_01            ON T_ANSP_OS_TYPE(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MATL_COLL_01          ON T_ANSP_MATL_COLL(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MATL_COLL_02          ON T_ANSP_MATL_COLL(OS_TYPE_ID);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MVMT_VAR_LINK_01      ON T_ANSP_MVMT_VAR_LINK(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MVMT_VAR_LINK_02      ON T_ANSP_MVMT_VAR_LINK(MVMT_VAR_LINK_ID, MOVEMENT_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MVMT_MATL_LINK_01     ON T_ANSP_MVMT_MATL_LINK(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_MVMT_MATL_LINK_02     ON T_ANSP_MVMT_MATL_LINK(MOVEMENT_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_VALUE_AUTOREG_01      ON T_ANSP_VALUE_AUTOREG(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_VALUE_AUTOREG_02      ON T_ANSP_VALUE_AUTOREG(COLUMN_ID, MOVEMENT_ID, DISUSE_FLAG, MVMT_VAR_LINK_ID, ASSIGN_SEQ);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_TGT_HOST_01           ON T_ANSP_TGT_HOST(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_TGT_HOST_02           ON T_ANSP_TGT_HOST(EXECUTION_NO, OPERATION_ID, MOVEMENT_ID, SYSTEM_ID, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_VALUE_01              ON T_ANSP_VALUE(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_VALUE_02              ON T_ANSP_VALUE(EXECUTION_NO, OPERATION_ID, MOVEMENT_ID, SYSTEM_ID, MVMT_VAR_LINK_ID, ASSIGN_SEQ, DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSP_EXEC_STS_INST_01      ON T_ANSP_EXEC_STS_INST(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSC_TWR_INSTANCE_GROUP_01 ON T_ANSC_TWR_INSTANCE_GROUP(DISUSE_FLAG);
CREATE INDEX IF NOT EXISTS IND_T_ANSC_TWR_ORGANIZATION_01   ON T_ANSC_TWR_ORGANIZATION(DISUSE_FLAG);
-- ------------------------------------------------------------
-- ▲ INDEX CREATE END
-- ------------------------------------------------------------
