-- 100101 リモートリポジトリ
CREATE TABLE IF NOT EXISTS T_CICD_REPOSITORY_LIST
(
    REPO_ROW_ID                     VARCHAR(40),                                -- 項番
    REPO_NAME                       VARCHAR(255),                               -- リモートリポジトリ名
    REMORT_REPO_URL                 VARCHAR(4096),                              -- リモートリポジトリ(URL)
    ...
    PROXY_ADDRESS                   VARCHAR(4096),                              -- プロキシーアドレス
...
CREATE TABLE IF NOT EXISTS T_CICD_REPOSITORY_LIST_JNL
(
...
-- 100102 リモートリポジトリ資材
CREATE TABLE IF NOT EXISTS T_CICD_MATL_LIST
(
...
-- 100103 資材紐付
CREATE TABLE IF NOT EXISTS T_CICD_MATL_LINK
(
...
CREATE TABLE IF NOT EXISTS T_CICD_MATL_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- M001 GITプロトコル種別
CREATE TABLE IF NOT EXISTS T_CICD_GIT_PROTOCOL_TYPE
(
...
-- M002 GITリポジトリ種別
CREATE TABLE IF NOT EXISTS T_CICD_GIT_REPOSITORY_TYPE
(
...
-- M003 GITリポジトリ同期状態
CREATE TABLE IF NOT EXISTS T_CICD_REPO_SYNC_STATUS
(
...
-- M004 ITA素材タイプ
CREATE TABLE IF NOT EXISTS T_CICD_MATL_TYPE
(
...
-- M005 資材ファイルタイプ
CREATE TABLE IF NOT EXISTS T_CICD_MATL_FILE_TYPE
(
...
CREATE OR REPLACE VIEW V_CICD_REPOSITORY_MATL_PATH_LINK AS
SELECT
...
CREATE OR REPLACE VIEW V_CICD_MATL_TYPE AS
SELECT
