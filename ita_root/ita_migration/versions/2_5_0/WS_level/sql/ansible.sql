...
-- ------------------------------------------------------------
ALTER TABLE T_ANSL_EXEC_STS_INST     ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSL_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSL_EXEC_STS_INST     ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
ALTER TABLE T_ANSL_EXEC_STS_INST_JNL ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSL_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSL_EXEC_STS_INST_JNL ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
...
-- -    I_AG_BUILDER_OPTIONS             ansible-builder パラメータ  追加
-- ------------------------------------------------------------
ALTER TABLE T_ANSP_EXEC_STS_INST     ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSP_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSP_EXEC_STS_INST     ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
ALTER TABLE T_ANSP_EXEC_STS_INST_JNL ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSP_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSP_EXEC_STS_INST_JNL ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
...
-- -    I_AG_BUILDER_OPTIONS             ansible-builder パラメータ  追加
-- ------------------------------------------------------------
ALTER TABLE T_ANSR_EXEC_STS_INST     ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSR_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSR_EXEC_STS_INST     ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
ALTER TABLE T_ANSR_EXEC_STS_INST_JNL ADD  ABORT_EXECUTE_FLAG               VARCHAR(2)    AFTER STATUS_ID;
ALTER TABLE T_ANSR_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_ANS_PLAYBOOK_HED_DEF;
ALTER TABLE T_ANSR_EXEC_STS_INST_JNL ADD  I_AG_EXECUTION_ENVIRONMENT_NAME  VARCHAR(255)  AFTER I_AG_BUILDER_OPTIONS;
