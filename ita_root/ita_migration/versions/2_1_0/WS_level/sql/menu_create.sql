...
-- パラメータシート定義一覧
ALTER TABLE T_MENU_DEFINE ADD COLUMN IF NOT EXISTS HOSTGROUP VARCHAR(2) AFTER VERTICAL;
ALTER TABLE T_MENU_DEFINE_JNL ADD COLUMN IF NOT EXISTS HOSTGROUP VARCHAR(2) AFTER VERTICAL;
