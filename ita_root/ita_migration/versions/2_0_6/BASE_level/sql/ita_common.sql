-- OrganizationDB管理
CREATE TABLE IF NOT EXISTS T_COMN_ORGANIZATION_DB_INFO
(
...
-- インデックス
CREATE INDEX IF NOT EXISTS IND_T_COMN_ORGANIZATION_DB_INFO_01 ON T_COMN_ORGANIZATION_DB_INFO (DISUSE_FLAG);
