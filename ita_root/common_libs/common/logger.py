...
class AppChildLog:
    ...
    def critical(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message), "CRITICAL")
    ...
    def exception(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message))
    ...
    def error(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message), "ERROR")
    ...
    def warning(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message), "WARNING")
    ...
    def info(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message), "INFO")
    ...
    def debug(self, message):
        ...
        Arguments:
            message: message for output
        """
        self.output_log(self.__env_message + str(message), "DEBUG")
    ...
    def output_log(self, message="", loglevel="INFO"):
        try:
            message = f"[{datetime.datetime.now().strftime('%Y/%m/%d %H:%M:%S.%f')[:-3]}][{loglevel}] " + str(message)
