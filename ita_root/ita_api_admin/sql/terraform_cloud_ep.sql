-- インターフェース情報
CREATE TABLE IF NOT EXISTS T_TERE_IF_INFO
(
    ...
    TERRAFORM_PROXY_ADDRESS         VARCHAR(4096),                              -- プロキシサーバアドレス
...
CREATE TABLE IF NOT EXISTS T_TERE_IF_INFO_JNL
(
...
-- Organization管理
CREATE TABLE IF NOT EXISTS T_TERE_ORGANIZATION
(
...
CREATE TABLE IF NOT EXISTS T_TERE_ORGANIZATION_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Workspace管理
CREATE TABLE IF NOT EXISTS T_TERE_WORKSPACE
(
...
CREATE TABLE IF NOT EXISTS T_TERE_WORKSPACE_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Module素材集
CREATE TABLE IF NOT EXISTS T_TERE_MODULE
(
...
CREATE TABLE IF NOT EXISTS T_TERE_MODULE_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Policy管理
CREATE TABLE IF NOT EXISTS T_TERE_POLICY
(
...
CREATE TABLE IF NOT EXISTS T_TERE_POLICY_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Policy set管理
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET
(
...
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Policy set-Policy紐付
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET_POLICY_LINK
(
...
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET_POLICY_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET_WORKSPACE_LINK
(
    POLICYSET_POLICY_LINK_ID        VARCHAR(40),                                -- 項番(UUID)
    POLICY_SET_ID                   VARCHAR(40),                                -- PolicySet(ID連携)
...
CREATE TABLE IF NOT EXISTS T_TERE_POLICYSET_WORKSPACE_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Movement-Module紐付
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_MOD_LINK
(
...
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_MOD_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- 変数ネスト管理
CREATE TABLE IF NOT EXISTS T_TERE_NESTVAR_MEMBER_MAX_COL
(
...
CREATE TABLE IF NOT EXISTS T_TERE_NESTVAR_MEMBER_MAX_COL_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- 代入値自動登録設定
CREATE TABLE IF NOT EXISTS T_TERE_VALUE_AUTOREG
(
...
CREATE TABLE IF NOT EXISTS T_TERE_VALUE_AUTOREG_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- 作業管理
CREATE TABLE IF NOT EXISTS T_TERE_EXEC_STS_INST
(
...
CREATE TABLE IF NOT EXISTS T_TERE_EXEC_STS_INST_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- 代入値管理
CREATE TABLE IF NOT EXISTS T_TERE_VALUE
(
...
CREATE TABLE IF NOT EXISTS T_TERE_VALUE_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Module-変数紐付
CREATE TABLE IF NOT EXISTS T_TERE_MOD_VAR_LINK
(
...
CREATE TABLE IF NOT EXISTS T_TERE_MOD_VAR_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- メンバー変数管理
CREATE TABLE IF NOT EXISTS T_TERE_VAR_MEMBER
(
...
CREATE TABLE IF NOT EXISTS T_TERE_VAR_MEMBER_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Movement-変数紐付
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_VAR_LINK
(
...
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_VAR_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
...
-- Movement-メンバー変数紐付
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_VAR_MEMBER_LINK
(
...
CREATE TABLE IF NOT EXISTS T_TERE_MVMT_VAR_MEMBER_LINK_JNL
(
    JOURNAL_SEQ_NO                  VARCHAR(40),                                -- 履歴用シーケンス
    JOURNAL_REG_DATETIME            DATETIME(6),                                -- 履歴用変更日時
    JOURNAL_ACTION_CLASS            VARCHAR (8),                                -- 履歴用変更種別
