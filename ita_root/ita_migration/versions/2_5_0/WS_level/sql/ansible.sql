...
ALTER TABLE T_ANSL_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
...
ALTER TABLE T_ANSL_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
...
ALTER TABLE T_ANSP_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
...
ALTER TABLE T_ANSP_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
...
ALTER TABLE T_ANSR_EXEC_STS_INST     ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
...
ALTER TABLE T_ANSR_EXEC_STS_INST_JNL ADD  I_AG_BUILDER_OPTIONS             TEXT          AFTER I_AG_EXECUTION_ENVIRONMENT_NAME;
