...
*/}}
{{- define "ita-by-ansible-towermaster-sync.name" -}}
...
*/}}
{{- define "ita-by-ansible-towermaster-sync.fullname" -}}
...
*/}}
{{- define "ita-by-ansible-towermaster-sync.chart" -}}
...
Common labels
*/}}
{{- define "ita-by-ansible-towermaster-sync.labels" -}}
helm.sh/chart: {{ include "ita-by-ansible-towermaster-sync.chart" . }}
{{ include "ita-by-ansible-towermaster-sync.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ita-by-ansible-towermaster-sync.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ita-by-ansible-towermaster-sync.name" . }}
...
{{- default (include "ita-by-ansible-towermaster-sync.fullname" .) .Values.serviceAccount.name }}
{{- else }}
