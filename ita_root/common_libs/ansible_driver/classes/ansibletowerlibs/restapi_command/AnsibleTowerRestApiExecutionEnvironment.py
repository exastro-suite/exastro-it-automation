...
class AnsibleTowerRestApiExecutionEnvironment(AnsibleTowerRestApiBase):

    """
    【概要】
        AnsibleTower execution environments系を呼ぶ クラス
    """

    API_PATH = "execution_environments/"

    @classmethod
    def get(cls, RestApiCaller):

        # REST APIアクセス
        method = "GET"
        response_array = RestApiCaller.restCall(method, cls.API_PATH)
